...
public class UserAgentUtil {
	...
	public static void main(String[] args) {
		UserAgent userAgent = UserAgentUtil.getUserAgent("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.73 Safari/537.36");
		System.out.println(JsonUtil.toJson(userAgent));
	}
	
	private static String[] phoneKeyWords = new String[]{"nokia", "sony", "ericsson", "mot", "samsung", "htc", "sgh", "lg", "sharp", "sie-"
