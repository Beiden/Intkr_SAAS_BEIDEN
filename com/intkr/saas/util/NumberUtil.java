...
public class NumberUtil extends BaseToolBox {

	public static String toCH(Integer num) {
		if (num == null) {
			return "";
		}
		return NumberToCH.numberToCH(num);
	}

	public static String toCH(Long num) {
		if (num == null) {
			return "";
		}
		return NumberToCH.numberToCH(num.intValue());
	}
