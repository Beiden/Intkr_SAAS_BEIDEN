...
public class ManagerImplMaker {

	public static File getFile() {
		String fileName = Context.projectDir + "src/main/java/" + Context.getClazDir() + "manager" + Context.getModuleDir() + "/impl/" + Context.getTable().getClazName() + "ManagerImpl.java";
	...
	public static void maker() {
		...
		String content = TemplateEngine.merge("template/ManagerImplTemplate", param);
