...
public class ModelMaker {
	...
	private static File getFile() {
		String fileDirectory = "src/main/webapp/IK/templates/asset/model";
		String fileName = Context.projectDir + fileDirectory + Context.getModuleDir() + "/" + Context.getTable().getClazName() + "ModelJS.vm";
		File file = new File(fileName);
		return file;
	}
	
	private static File getFile2() {
		String fileDirectory = "src/main/webapp/asset/model";
		String fileName = Context.projectDir + fileDirectory + Context.getModuleDir() + "/" + Context.getTable().getClazName() + "Model.js";
		File file = new File(fileName);
		return file;
	}
	...
	public static void maker() {
		...
		String content = TemplateUtil.merge(TemplateEngine.getContent("template/ModelTemplate.vm"), param);
