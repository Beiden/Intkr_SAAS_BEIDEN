...
public class MenuMgr {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		File file = new File(SystemProperties.getWebappPath() + "/IK/templates/screen/themes/" + SessionClient.getTheme(request) + "/control/menuSetting.vm");
		if (file.exists()) {
			request.setAttribute("menuSetting", "menuSetting");
		}
