...
import com.intkr.saas.module.action.item.ItemPropertyValueAction;
 ...
 * @version 1.0
 */
public class ItemPropertyValueMgr {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		ItemPropertyValueBO query = ItemPropertyValueAction.getParameter(request);
		query.setQuery("orderBy", "gmt_created");
		query.setQuery("order", "desc");
		query = itemPropertyValueManager.selectAndCount(query);
