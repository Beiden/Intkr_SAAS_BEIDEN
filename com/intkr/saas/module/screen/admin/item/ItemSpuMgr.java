...
import com.intkr.saas.module.action.item.SpuAction;
...
public class ItemSpuMgr {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		ItemSpuBO query = SpuAction.getParameter(request);
		query.setQuery("orderBy", "gmt_created");
		query.setQuery("order", "desc");
		query = itemSpuManager.selectAndCount(query);
