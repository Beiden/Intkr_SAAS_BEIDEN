...
import com.intkr.saas.module.action.mms.EmailSignatureAction;
 ...
 * @version 1.0
 */
public class EmailSignatureMgr {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		EmailSignatureBO query = EmailSignatureAction.getParameter(request);
