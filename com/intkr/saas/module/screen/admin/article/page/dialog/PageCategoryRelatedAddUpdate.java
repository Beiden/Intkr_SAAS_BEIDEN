 ...
 * @version 1.0
 */
public class PageCategoryRelatedAddUpdate {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		String cmsPageCategoryRelatedId = RequestUtil.getParam(request, "cmsPageCategoryRelatedId");
		PageCategoryRelatedBO cmsPageCategoryRelated = manager.get(cmsPageCategoryRelatedId);
		request.setAttribute("cmsPageCategoryRelated", cmsPageCategoryRelated);
