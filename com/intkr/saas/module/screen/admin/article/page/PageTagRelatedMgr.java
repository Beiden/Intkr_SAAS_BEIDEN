...
import com.intkr.saas.module.action.article.page.PageTagRelatedAction;
 ...
 * @version 1.0
 */
public class PageTagRelatedMgr {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		PageTagRelatedBO query = PageTagRelatedAction.getParameter(request);
