 ...
 * 
 * @author Beiden
 * @date 2016-5-23 下午9:49:39
 * @version 1.0
 */
public class SignUpByWeiXinPCGetRegisterData {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		String redirectURI = "http://" + saasClientManager.getSaasDomain(SessionClient.getSaasId(request)) + "/sign/signUpByWeiXinPC.html";
