	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (wxAccount != null && IdEngine.isValidate(wxAccount.getUserId())) {
				...
				ResponseUtil.sendRedirect(request, response, "/sign/signInByWeiXinPCConfirmLogin.html?code=signIn");
				return;
			...
			logger.error("", e);
			ResponseUtil.sendRedirect(request, response, "/sign/signInByWeiXinPCConfirmLogin.html?code=signInError");
		}
