...
public class SendMail {
	...
	protected static final Logger logger = LoggerFactory.getLogger(SendMail.class);

	private static String username = "o2tvirc@163.com";
	private static String password = "XmRjjnqA25E3";
	private static String smtpServer = "smtp.163.com";
	private static String fromMailAddress = "o2tvirc@163.com";
	private static String toMailAddress = "443818603@qq.com";
	...
	public static void main(String[] args) throws Exception {
		...
		bodyPart.setDataHandler(new DataHandler("测<img src=http://a3.qpic.cn/psb?/V13MrsHk3iiNc8/CxzCwMaEHBzxJzRY6XuZezh3ZSFDWtCO6MCpGY39FJw!/b/dA4AAAAAAAAA&bo=UwJKAwAAAAAFADs!&rf=viewer_4 />试", "text/html;charset=GBK"));// 网页格式
		/** *************************************************** */
